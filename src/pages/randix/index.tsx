...
const HomePage = () => (
    ...
    <p>Randix is a two-player game, where players take turns removing pieces from the board.
    The goal is to force the other player to remove the last piece. On your turn you may remove
    one or more <span><img alt='pieces' src={MarbleImage} /></span> either horizontally or vertically.</p>
    <p>Click and drag your mouse to select the pieces you want to remove but be aware of <span><img alt='stone' src={StoneImage} /></span> that block your selection.</p>
