...
<div>
  <ul className="nav nav-tabs">
    <li className="active"><a data-toggle="tab" href="#home">Play!</a></li>
    <li><a data-toggle="tab" href="#menu1">Leaderboard</a></li>
  </ul>
  ...
  <div className="container">
    <div className="row">
        ...
        <div className={classes.newGame}>
          <a href="#newGame" data-toggle="collapse" id={classes[auth.user.reserved]}>Host New Game</a>
          <p id={classes[auth.user.reserved]}>Waiting other players...</p>
          <button type="button" className="btn btn-default" id={classes[auth.user.reserved]} onClick={leaveGame}>Leave Game</button>
          <div id="newGame" className="collapse">
            <form id={classes[auth.user.reserved]}>
              <p>Leave this field empty if you do not want to restrain access to your game.</p>
              <div className="form-group">
                <label htmlFor="pwd">Password</label>
                <input type="password" className="form-control" id="pwd" placeholder="Enter Password"/>
              </div>
              <button type="button" className="btn btn-default" onClick={()=>{checkAuth(); newGame(document.getElementById('pwd').value)}}>Start!</button>
            </form>
          </div>
        </div>
    </div>
      ...
      <div className="row">
          <div className="panel panel-default">
            ...
            <table className="table" id={classes.tableFixed}>
              <thead className="well">
                <tr>
                    <th className="col-xs-4">Rank</th><th className="col-xs-4">Name</th><th className="col-xs-4">Level</th>
                </tr>
              </thead>
              <tbody>
                ...
                <tr>
                  ...
                  <td className="col-xs-4"><span className="badge">{u.rank}</span></td>
                </tr>))}
              </tbody>
            </table>
          </div>
